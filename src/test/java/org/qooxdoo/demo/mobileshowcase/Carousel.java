...
public class Carousel extends Mobileshowcase {
	...
	public void carousel() throws InterruptedException {
		...
		Touchable nextPage = (Touchable) driver.findWidget(By.xpath("//div[text() = 'Next Page']/ancestor::div[contains(@class, 'button')]"));
		nextPage.tap();
		Thread.sleep(1000);
		...
		Touchable addButton = (Touchable) driver.findWidget(By.xpath("//div[text() = 'Add more pages']/ancestor::div[contains(@class, 'button')]"));
		addButton.tap();
